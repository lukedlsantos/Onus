        ...
        if (d === 1) {
          ...
          if (phaseNum === 1) {
            ...
            exercises = [
              ...
              { name: "Slab and Dynamic Slab", category: "Progress Hook", sets: 1, reps_or_duration: "1 set", intensity: "RPE 6", rest: "Self-paced", notes: "Intentionally direct center of mass to negative volumes or no-tex holds" },
