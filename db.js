    ...
    for (let w = 1; w <= 4; w++) {
      ...
      for (let d = 1; d <= 7; d++) {
        ...
        if (d === 1) {
          ...
          // DAY 4 (Active Recovery Day / Absolute Rest Day)
          sessionType = "recovery";
          duration = 45;
          intensity = 3;

          if (phaseNum === 1 && isDeload) {
            title = "Absolute Rest Day";
            objective = "Complete systemic and nervous system rest.";
            exercises = [
              { name: "Absolute Reset", category: "General", sets: 1, reps_or_duration: "None", intensity: "RPE 1", rest: "None", notes: "Zero training parameters. CNS and skin reset." }
            ];
          } else {
