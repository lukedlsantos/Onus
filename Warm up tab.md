# Project Onus: Independent Off-The-Wall Warm-Up Tab Specification

This file serves as the absolute technical blueprint for the separate, standalone "Warm-Up" component layout in Project Onus. These protocols are executed 100% off the wall (ground, mats, or tracking accessories) to safely mobilize all primary joint structures, regulate breathing mechanics, and activate muscular recruitment cascades before an athlete ever touches a climbing wall or starts a main training session.
...
1.  **Bodyweight Turkish Get-Ups (3 Reps per side):** Slow, sequential step-by-step floor to standing transitions while maintaining a locked, packed shoulder tracking vertical path.
2.  **Dynamic Copenhagen Side Planks (8 Reps per side):** Anchor top foot onto gym bench/box. Drive hips upward into standard side plank alignment using pure adductor and deep lateral core bracing.
3.  **Banded Face Pulls with Dynamic Overhead Press (15 Reps):** Pull resistance band to nose bridge maximizing scapular retraction, then fluidly press hands straight overhead while holding contraction.
4.  **Single-Leg Romanian Deadlifts (10 Reps per side):** Bodyweight focus. Hinge at hips with a straight trailing leg to fire hamstrings, glutes, and ankle stabilization loops.

### Section C: Off-Wall Max Force Ceilings ($f_{max}$) Triggering (15 Minutes)
*Requires a ground-anchored pull rig paired with a digital crane scale/crane monitor. Pull downward at $100\%$ intensity against an unyielding anchor to safely fire the neurological system:*
* **Ramp-Up Sequence:** Pull 3 distinct sets $\times$ 5 seconds at progressive effort thresholds ($60\% \rightarrow 75\% \rightarrow 85\%$).
* **Peak Recruitment Pulls:** Perform 3 sets $\times$ 5 seconds of absolute maximum downward intention utilizing a strict half-crimp grip configuration on a $20\text{mm}$ testing frame edge.
* *Rest Constraints:* Enforce an automated, non-skippable **2-minute recovery clock** between max efforts to ensure complete ATP-PC chemical replenishment.

### Section D: Off-Wall Plyometric & Nervous System Acceleration (15 Minutes)
*Force explosive Rate of Force Development (RFD) pathways via maximum velocity commands:*
...
## 5. App UI Architecture & Interactive Timer Spec

The UI for this tab must run as a linear workflow wizard. Engaging any warm-up routing pauses background session timelines and tracks compliance metrics.
...
│                                                        │
│ [X] Phase A: Full-Body Mobility Chain          (10:00) │
│ [ ] Phase B: Shoulder/Spine Stabilization     (10:00) │
│ [ ] Phase C: Off-Wall Isometric Tendon Influx  (10:00) │
│                                                        │
│ ── STATION DASHBOARD CARD ──────────────────────────── │
│ » Exercise: Dynamic 90/90 Hip Switches                 │
│ » Completed Sets Tracker: 1 / 2                        │
│ » Current Step Countdown Timer: [ 01:14 ]              │
│                                                        │
│ [ PAUSE AUTOMATION ]                  [ SKIP STATION ] │
└────────────────────────────────────────────────────────┘
```
