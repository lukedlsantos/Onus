...
*   **Off-Wall Movement Prep [30 Minutes]:**
    ...
    *   **Hips, Pelvic Core & Lower Chain:** 10 dynamic 90-90 hip switches, 8 dynamic hip CARs per side, and 12 reps resisted dorsiflexion ankle lunges per leg to prepare ankles for steep, deep stepping.
*   **Autoregulated Neural Screening [5 Minutes]:**
    *   Perform 2 submaximal pulls against a Tindeq portable strain gauge in half-crimp position at 50% and 75% MVC.
    *   If daily force output is down by **>10%** from baseline, immediately scale back the intensity/reps of the lactic circuits to prevent connective pulley injury during high-fatigue training.
*   **On-Wall Progressive Ramp [10 Minutes]:** Climb 3 easy slab/vertical problems, focusing on straight-arm skeletal stacking and hip centration on vertical terrain. Zero forearm pump.
...
*   **WEEK 1 (Baseline Profile Block):** Day 1 4x4s: **4 blocks of 4 climbs** (RPE 8.5, 45s rest between climbs, 5m rest between blocks). Day 3 Links: **5 repetitions of 25-move links**.
*   **WEEK 2 (Accumulation Block):** Day 1 4x4s: **4 blocks of 5 climbs** (RPE 9, 45s rests). Day 3 Links: **6 repetitions of 30-move links**.
*   **WEEK 3 (Peak Strain Matrix Block):** Day 1 4x4s: **5 blocks of 4 climbs** (RPE 9.5, 45s rests). Day 3 Links: **7 repetitions of 35-move links**.
*   **WEEK 4 (Automated Deload Window):** Automated volume reduction of 50%. Core Driver capacity loops are cut. Duration drops to exactly **45 minutes** at an easy vertical pace. Rests are completely unconstrained. Lactic circuits are completely eliminated.
...
*   **Day 1:** Training Session — High-Neural Trigger into Lactic Capacity [3 Hours]
*   **Day 2:** Restorative Session — Technique Under Pump & Recovery [2 Hours]
*   **Day 3:** Training Session — High-Fatigue Link Sessions & Lifting [3 Hours]
*   **Day 4:** Asynchronous Block — Optional Active Flush OR Complete Passive Rest
*   **Day 5:** Training Session — Power Endurance Peak Overload (4x4s) [3 Hours]
...
*   **Climbing PT Core Container [40 Mins]:**
    *   *Exercises:* 3 sets $\times$ 10 reps of standing cable Pallof presses, side planks (45s/side), Swiss-ball Stir-the-Pot, and Seated Contra-Lateral Leg Raises.
...
*   *Protocol:* Complete recovery to allow supercompensation before peak performance phase.
